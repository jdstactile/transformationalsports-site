        ...
        <div className="grid gap-12 md:grid-cols-3">
          ...
          <div>
            ...
            <p className="mt-4 text-sm leading-relaxed text-white/60">
              Empowering athletes and individuals through transformative coaching,
              mindset training, and holistic sports development.
            </p>
          </div>

          {/* Column 2 — Quick Links */}
          <div>
            <h4 className="mb-4 text-sm font-bold uppercase tracking-[2px] text-white/80">
              Quick Links
            </h4>
            <ul className="flex flex-col gap-3">
              {quickLinks.map(({ label, href }) => (
                <li key={href}>
                  <Link
                    href={href}
                    className="text-sm text-white/60 transition-colors duration-200 hover:text-amber"
                  >
                    {label}
                  </Link>
                </li>
            ...
            <div className="mb-4 flex items-center gap-4">
              {socialLinks.map(({ label, href, icon }) => (
                <a
                  ...
                  aria-label={label}
                  className="text-white/60 transition-colors duration-200 hover:text-amber"
                >
                  {icon}
                </a>
              ))}
